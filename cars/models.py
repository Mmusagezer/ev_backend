...
class CarListing(models.Model):
    ...
    # Basic details
    title = models.CharField(max_length=200, default="")  # Add a title field
    ...
    is_active = models.BooleanField(default=True)  # Simple active/inactive flag
    ...
    def __str__(self):
        return f"{self.title or self.package} - {self.year} - ${self.price}"